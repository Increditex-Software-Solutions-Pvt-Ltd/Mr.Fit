                  ...
                  <div className="card border-0">
                    ...
                    <div className="card-footer bg-transparent border-0">
                      <h3 className="text-headblack">
                        NFL Draft 2024 ‘The Beast’ Guide: Dane Brugler’s
                        scouting reports and player rankings
                      </h3>
                      <p className="text-stone text-lg mb-0">
                        This year's version of The Beast is the biggest ever,
                        with more than 400 player profiles and nearly 2,000
                        prospects
                      </p>
                      <div
                ...
                <ul className="list-unstyled">
                  <li>
                    ...
                    >
                      ...
                      <div className="col-lg-8">
                        <h5 className="mb-0">
                          2024 NFL Mock Draft: Could quarterbacks go 1-2-3-4
                          atop Round 1?{" "}
                        </h5>
                        <div
                          className="text-stone text-sm
                  ...
                  <li>
                    ...
                    >
                      ...
                      <div className="col-lg-8">
                        <h5 className="mb-0">
                          As a son and brother, Penn State's Adisa Isaac
                          'juggled a lot' — now comes the NFL
                        </h5>
                        <div
                          className="text-stone text-sm
                   text-stone text-sm mt-1"
              ...
              <ul className="list-unstyled">
                  ...
                  >
                    ...
                    <div className="col-lg-8">
                      ...
                      <p className="text-stone text-lg mb-0">
                        ...
                        are the best players available to fill those holes?
                        Mocks,
                      </p>
                      <div
                        className="text-stone text-sm
                ...
                <li>
                  ...
                  >
                    ...
                    <div className="col-lg-8">
                      <h4 className="mb-0">
                        Seattle Seahawks NFL Draft 2024 guide: Picks,
                        predictions and key needs
                      </h4>
                      <p className="text-stone text-lg mb-0">
                        Everything you need to know about the Seahawks as the
                        2024 NFL Draft approaches, including mock drafts,
                      </p>
                      <div
                        className="text-stone text-sm
                   text-stone text-sm mt-1"
                ...
                <li>
                  ...
                  >
                    ...
                    <div className="col-lg-8">
                      ...
                      <p className="text-stone text-lg mb-0">
                        The cost to trade up for a quarterback is prohibitive —
                        if not impossible — but Oregon State's Taliese Fuaga
                        would
                      </p>
                      <div
                        className="text-stone text-sm
                ...
                <li>
                  ...
                  >
                    ...
                    <div className="col-lg-8">
                      <h4 className="mb-0">
                        Why Broncos' climb back to relevancy must start by
                        nailing long-awaited top pick{" "}
                      </h4>
                      <p className="text-stone text-lg mb-0">
                        The Broncos have derived far less impact from
                        first-round picks the last decade-plus than other teams
                        in the
                      </p>
                      <div
                        className="text-stone text-sm
                ...
                <li>
                  ...
                  >
                    ...
                    <div className="col-lg-8">
                      ...
                      <p className="text-stone text-lg mb-0">
                        The 49ers own 10 picks in the upcoming NFL Draft and
                        have a big need at offensive tackle.
                      </p>
                      <div
                        className="text-stone text-sm
                   text-stone text-sm mt-1"
